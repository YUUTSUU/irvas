...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(state, calcScroll);
  ...
  Object(_modules_image__WEBPACK_IMPORTED_MODULE_6__["default"])(calcScroll);
});
...
var forms = function forms(state) {
  function bindForms(formSelector, inputSelector, nameSelector, phoneSelector) {
    var form = document.querySelectorAll(formSelector),
      ...
      item.addEventListener('submit', function (event) {
        ...
        postData(data).then(function (res) {
          ...
          setTimeout(function () {
            ...
            windowModal.forEach(function (item) {
...
var image = function image(calcScroll) {
  function bindImage(selector) {
    var worksWrapper = document.querySelector(selector),
    ...
    worksWrapper.addEventListener('click', function (event) {
      event.preventDefault();

      if (event.target && event.target.classList.contains('preview')) {
        imageItem.forEach(function (item) {
          if (event.target === item) {
            var path = event.target.parentNode.getAttribute('href');
            imagePopup.style.display = 'flex';
            document.body.style.overflow = 'hidden';
            document.body.style.marginRight = "".concat(scrollOffset, "px");
...
var modals = function modals(state, calcScroll) {
  function bindModal(openSelector, modalSelector, closeSelector) {
    ...
    var open = document.querySelectorAll(openSelector),
    ...
    open.forEach(function (item) {
      item.addEventListener('click', function (event) {
        ...
        var message = 'Заполните все данные!';
        var statusMessage = document.createElement('div');
        statusMessage.classList.add('status');
        statusMessage.style.paddingTop = '10px';
        var statusMessageTimeout = setTimeout(function () {
...
var tabs = function tabs() {
  function bindTabs(headerSelector, tabsSelector, contentSelector, activeSelector) {
...
var timer = function timer(deadline) {
  function bindTime(date) {
    ...
    function ubdateTime() {
      var timer = getTimeRemaining(date);
      days.innerHTML = addZero(timer.days), hours.innerHTML = addZero(timer.hours), minutes.innerHTML = addZero(timer.minutes), seconds.innerHTML = addZero(timer.seconds);
